    ...
    <div class="container">
        ...
        <div class="middle_wrapper">
            <div class="dashboard_title">
                ...
                <a href="tambah_nilai_admin"><Button class="tambah_btn">Tambah Nilai</Button></a>
            </div>
                ...
                foreach ($nilai as $u) :
                    ...
                    <tr>
                        ...
                        <td class="ubah_wrapper">
                            <a href="<?php echo site_url('Auth/hapus_nilai_admin/'.$u['id_mengajar']); ?>"
                                class="btn_danger">Hapus</a> |
                            <a href="<?php echo site_url('Auth/edit_nilai_admin/'.$u['id_mengajar']); ?>"
